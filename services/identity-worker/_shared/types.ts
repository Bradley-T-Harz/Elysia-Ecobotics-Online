...
export interface IdentityEnv extends RuntimeIdentityBindings {
  IDENTITY_DELETION_FINALIZER_ENABLED?: string;
  IDENTITY_DELETION_FINALIZER_PROVIDER?: string;
  IDENTITY_DELETION_FINALIZER_BATCH_LIMIT?: string;
  IDENTITY_DELETION_FINALIZER_LEASE_SECONDS?: string;
  IDENTITY_DELETION_FINALIZER_RETRY_SECONDS?: string;
