...
function sourceStatusTable(sourceTable: string) {
  if (["work_with_requests", "stewardship_recognition_requests", "commune_post_requests", "living_library_source_suggestions", "broken_link_reports"].includes(sourceTable)) return sourceTable;
  return null;
}
