...
export default function FundingExplanation() {
  return <section className="section-card" id="how-ecosyneva-is-funded" aria-labelledby="funding-explanation-title">
    ...
    <p>Donations in the independent giving directory go directly to the selected organizations through their own channels. EcoSyneva does not receive, hold, route or take a commission on those donations. Optional stewardship evidence review and recognition are separate from payment and do not certify tax treatment or imply a partnership.</p>
    <p className="boundary-note">Support checkout and Marketplace payments are not active. They are being prepared for payment-provider review and operational qualification. This page does not claim provider approval. Free software, community participation and the current free hosted allowance remain separate from that preparation.</p>
