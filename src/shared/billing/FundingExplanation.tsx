...
export default function FundingExplanation() {
  return <section className="section-card" id="how-ecosyneva-is-funded" aria-labelledby="funding-explanation-title">
    ...
    <p>Paid Marketplace sales are not active and are separate from Support. Any future paid third-party Marketplace sales would require separate provider/Connect qualification before activation and would identify the seller, offering, license, price, and applicable refund terms. Free Marketplace offerings remain free.</p>
    ...
    <p className="boundary-note">Current first-party Support availability is shown above. Paid third-party Marketplace checkout, seller onboarding, and creator payouts remain disabled pending separate platform/Connect qualification and activation. Free software, community participation, and the current free hosted allowance remain separate from that future commerce path.</p>
