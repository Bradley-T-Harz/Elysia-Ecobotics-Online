  ...
  return (
    <div className="page-stack">
      ...
      <section className="section-card archive-download-choice" aria-labelledby="local-download-choice-title">
        ...
        <p>The ordinary local release path and optional financial support are independent choices. A Support payment never unlocks, accelerates, verifies, personalizes, or changes an artifact.</p>
        <div className="two-column">
          <article className="feature-card"><p className="eyebrow">Free path</p><h3>$0 — Local Elysia release</h3><p>No Website Account, email, Stripe checkout, card, Support payment, recurring plan, supporter recognition, or payment-tracking gate is required. The links below go directly to the same official artifacts and verification materials available to everyone.</p><p className="boundary-note">Choose Setup for the guided user-local path, or select the exact package form that fits your Linux system.</p><a className="button-link button-link--primary" href="#release-downloads-title">Go to free downloads</a></article>
          <article className="feature-card"><p className="eyebrow">Separate and optional</p><h3>Support release work</h3><p>People who want to help sustain release engineering, security, hosting, documentation, and accessibility may choose a one-time Support payment. Checkout remains separate from every download and grants no extra capability or authority.</p><Link className="button-link" to="/support?source=products#support-checkout">Consider optional support</Link></article>
        </div>
      </section>
