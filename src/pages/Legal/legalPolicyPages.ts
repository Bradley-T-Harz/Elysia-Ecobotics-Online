...
export const legalPolicyPages: LegalPolicyPage[] = [
  ...
  },
  {
    "slug": "legal",
    "route": "/legal",
    "title": "Policy Index: Legal, Safety, Security, and Stewardship",
    "status": "Public operating policy",
    "lastUpdated": "2026-06-09",
    "body": "# Policy Index: Legal, Safety, Security, and Stewardship\n\n**Site:** Elysia Ecobotics Online  \n**Brand:** Elysia Ecobotics™  \n**Operator:** EcoSyneva Commons LLC  \n**Public URL:** https://elysia-ecobotics-online.pages.dev  \n**Status:** Public operating policy. Informational, not legal advice.  \n**Last updated:** 2026-06-09\n\n## Proposed routes\n\n- `/legal/privacy-policy`\n- `/legal/terms-of-use`\n- `/legal/community-guidelines`\n- `/legal/marketplace-developer-agreement`\n- `/legal/add-on-submission-policy`\n- `/legal/security-review-policy`\n- `/legal/vulnerability-disclosure-policy`\n- `/legal/dmca-copyright-policy`\n- `/legal/acceptable-use-policy`\n- `/legal/code-of-conduct`\n- `/legal/volunteer-contributor-disclaimer`\n- `/legal/donation-recognition-terms`\n\n## Public doctrine\n\nThe website is public and cloud-facing. The private local Elysia core remains local, governed, and user-controlled. Public accounts, Marketplace listings, Living Library sources, Commune posts, and Commons Circle membership must never silently become private Elysia memory or local machine access.\n\n## Publication readiness checklist\n\nMaintain role-based contact emails; add legal/business mailing address if needed; register or confirm a DMCA designated agent if relying on DMCA safe harbor; keep `/legal` route and policy detail routes linked from the footer; add Terms/Privacy agreement checkboxes where accounts or submissions require them; add security contact and optionally `/.well-known/security.txt`; maintain policy version/effective date; seek legal review before high-risk growth, paid add-ons, uploads, or major user-generated content.\n"
  },
  {
