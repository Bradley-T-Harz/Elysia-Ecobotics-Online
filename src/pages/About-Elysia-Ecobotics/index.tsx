  ...
  return (
    <div className="page-stack">
      ...
      >
        ...
        <p>The project joins local-first AI, ecological intelligence, add-on tooling, source libraries, public collaboration, and future robotics into one careful ecosystem.</p>
      </PageHero>
