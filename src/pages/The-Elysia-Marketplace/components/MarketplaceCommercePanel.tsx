...
export default function MarketplaceCommercePanel({ addon }: { addon: AddonManifest }) {
  ...
  if (!catalogAvailable || !offer) return <section className="marketplace-commerce-panel boundary-note"><FundingLink /><strong>No active economic offer for this version.</strong> Existing Marketplace review, saving, permission review, and local-install preparation remain available on their existing free paths.</section>;
  ...
  return <form className="marketplace-commerce-panel section-card" onSubmit={submit} noValidate aria-labelledby="marketplace-commerce-title">
    ...
    <FundingLink /><p>The reviewed listing, this commercial offer, a Website Account license, payment state, and Local Elysia installation are separate records and decisions.</p>
