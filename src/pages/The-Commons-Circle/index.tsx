    ...
    <div className={homebaseClasses} style={homeStyle}>
      ...
      <section className="commons-homebase-grid">
        <article className="section-card commons-signal-feed">
          ...
          <p className="boundary-note">This is a preview. The full private Signal Console handles Coding Cornucopia proposal decisions, Troubleshooting Grove proposed fixes/status updates, accepted/rejected outcomes, sandbox signals, and review notices.</p>
