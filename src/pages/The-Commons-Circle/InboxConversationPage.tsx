...
export default function InboxConversationPage() {
  ...
  if (!UUID_PATTERN.test(conversationId)) {
    return <div className="page-stack commons-circle-page"><PageHero eyebrow="Private conversation" title="Conversation unavailable"><p>The conversation address is invalid or unavailable.</p></PageHero><InboxSectionNavigation /></div>;
  }
