-- Repository Showcase structured metadata and public detail read policy.
...
begin
  ...
  begin
    alter table public.commune_repository_showcases validate constraint commune_repository_showcases_sandbox_review_status_check;
  exception when others then
    raise notice 'Repository Showcase sandbox review status constraint left not validated: %', sqlerrm;
  end;
end $;
