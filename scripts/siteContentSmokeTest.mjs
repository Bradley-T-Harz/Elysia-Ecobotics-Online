...
const constellationPublicAuthorityNoteRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-authority-note\s*\{(?=[^}]*border-radius:\s*999px)(?=[^}]*var\(--commons-theme-notice-bg\))/s;
...
const constellationPublicContributionsRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-contributions-card\s*\{(?=[^}]*min-height:\s*auto)(?=[^}]*padding:\s*clamp)/s;
...
const constellationPublicSafeAreaRootRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s*\{(?=[^}]*--profile-constellation-safe-inline:\s*clamp\(3\.25rem)(?=[^}]*scroll-margin-top:\s*11rem)(?=[^}]*padding-block-start:\s*clamp\(1\.75rem)/s;
...
const constellationPublicPlanetLabelRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-identity-card\s+\.commons-public-section-card__eyebrow,[\s\S]*?\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-badges-card\s+\.commons-public-section-card__eyebrow\s*\{(?=[^}]*transform:\s*translate\(clamp\(0\.28rem)/s;
assert(constellationPublicPlanetLabelRule.test(commonsProfileLayoutCss), "Constellation Map public large-planet labels should have scoped down/right safe-lane seating.");
const constellationPublicIdentitySafeZoneRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-identity-card\s*\{(?=[^}]*padding-inline-start:\s*var\(--profile-constellation-safe-inline\))(?=[^}]*padding-inline-end:\s*var\(--profile-constellation-safe-inline-end\))/s;
...
const constellationPublicIdentityContentRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-identity-card\s+>\s*:where\(h2,\s*\.commons-public-link-list\),[\s\S]*?\.commons-public-identity-card\s+>\s*p:not\(\.commons-public-section-card__eyebrow\):not\(\.commons-public-authority-note\)\s*\{(?=[^}]*transform:\s*translate\(clamp\(0\.12rem)/s;
...
const constellationPublicBadgesSafeZoneRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-badges-card\s*\{(?=[^}]*padding-inline-start:\s*var\(--profile-constellation-safe-inline\))(?=[^}]*padding-inline-end:\s*var\(--profile-constellation-safe-inline-end\))/s;
...
const constellationPublicIdentityNoteRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-identity-card\s+\.commons-public-authority-note\s*\{(?=[^}]*max-width:\s*min\(84%)(?=[^}]*23\.5rem)(?=[^}]*transform:\s*translate\(0\.35rem,\s*-0\.95rem\))/s;
...
const constellationPublicBadgesNoteRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-badges-card\s+\.commons-public-authority-note\s*\{(?=[^}]*max-width:\s*min\(84%)(?=[^}]*transform:\s*translate\(0\.35rem,\s*-1\.15rem\))/s;
assert(constellationPublicBadgesNoteRule.test(commonsProfileLayoutCss), "Constellation Map public badges warning note should be lifted inside the node.");
const constellationPublicBadgeChamberRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-badge-card\s*\{(?=[^}]*width:\s*min\(100%,\s*25rem\))(?=[^}]*max-width:\s*min\(92%,\s*25\.5rem\))/s;
...
const constellationPublicSlotSeatingRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-profile-slot--identity\s*\{(?=[^}]*transform:\s*translate\(0\.35rem,\s*0\.55rem\))[\s\S]*?\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-profile-slot--collections\s*\{(?=[^}]*transform:\s*translate\(-1\.15rem,\s*0\))/s;
...
const constellationPublicButtonLaneRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-profile-summary-card__edit,[\s\S]*?\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-profile-masthead__edit\s*\{(?=[^}]*margin-block-start:\s*clamp\(1\.45rem)(?=[^}]*justify-content:\s*center)/s;
...
const constellationPublicContributionRhythmRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-contributions-card\s+>\s*h2\s*\{(?=[^}]*margin-block-end:\s*clamp\(0\.12rem)/s;
...
const constellationPublicContributionGridRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map\s+\.commons-public-contribution-grid\s*\{(?=[^}]*gap:\s*clamp\(1\.05rem)(?=[^}]*padding-inline:\s*clamp\(0\.5rem,\s*1vw,\s*0\.85rem\)\s*clamp\(1\.45rem)/s;
assert(constellationPublicContributionGridRule.test(commonsProfileLayoutCss), "Constellation Map public contribution cards should keep scoped right-edge breathing room.");
const constellationPublicOrbitSofteningRule = /\.commons-profile-layout--public\.commons-profile-layout--constellation-map::before\s*\{(?=[^}]*opacity:\s*0\.42)[\s\S]*?\.commons-profile-layout--public\.commons-profile-layout--constellation-map::after\s*\{(?=[^}]*opacity:\s*0\.28)/s;
