...
assert(commons.includes("commons-circle-private-homebase-mantle") && commons.includes("commons-circle-private-banner-image"), "Commons Circle private homebase should expose private-only banner fit hooks.");
...
assert(styles.includes(".commons-circle-private-homebase-mantle .commons-circle-private-banner-image") && styles.includes(".commons-circle-customization-preview-mantle .commons-circle-customization-preview-banner-image"), "Commons Circle private banner fit CSS should stay rooted in private-only class hooks.");
assert(!publicProfile.includes("commons-circle-private-homebase-mantle") && !publicProfile.includes("commons-circle-customization-preview-mantle"), "Public Commons profile must not reference private Commons Circle banner fit hooks.");
