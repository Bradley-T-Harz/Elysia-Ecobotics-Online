...
assert(commons.includes("CommonsPrivateBannerArt") && commons.includes("commons-private-banner-art"), "Commons Circle private homebase and preview should use private-only banner artwork rendering.");
assert(styles.includes(".commons-private-banner-art") && styles.includes(".commons-private-banner-art__backdrop") && styles.includes(".commons-private-banner-art__foreground") && styles.includes("object-fit: contain"), "Private Commons Circle banner artwork should preserve full uploaded banner composition with a contained foreground layer.");
assert(!publicProfile.includes("commons-private-banner-art"), "Public Commons Profile must not use the private Commons Circle banner art helper.");
