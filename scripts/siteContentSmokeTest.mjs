...
assert(reviewClient.includes("loadStewardshipReceiptEvidence") && reviewClient.includes('createSignedUrl(file.storage_path, expiresInSeconds)') && reviewClient.includes("expiresInSeconds = 300"), "Stewardship reviewers need a bounded private-proof access path.");
