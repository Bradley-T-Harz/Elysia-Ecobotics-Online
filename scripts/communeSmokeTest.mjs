...
const governedSandboxMigration = await read("supabase/migrations/2026_07_13_sandbox_proxy_access_and_reservation.sql");
...
const communityVoteSoftDeleteRepairMigration = await read("supabase/migrations/2026_07_11_fix_commune_vote_soft_delete_rpc.sql");
...
assert(sandboxClient.includes('fetch("/api/sandbox/run"') && sandboxClient.includes("sandbox_unavailable") && sandboxClient.includes("policy_blocked"), "Coding Cornucopia authenticated same-origin sandbox client must fail closed.");
