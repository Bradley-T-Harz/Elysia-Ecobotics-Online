...
for (const jobPostField of ["Role title", "Organization / project", "Role type", "Paid / volunteer status", "Location details", "Time commitment", "Deadline", "Role summary", "Requirements / skills", "Safety notes", "Application status", "Anti-scam review", "Private application note"]) {
