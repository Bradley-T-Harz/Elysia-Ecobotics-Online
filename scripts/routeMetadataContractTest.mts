...
assert(!routeMetadataForPath("/build-log/not-a-published-entry").description.includes("not-a-published-entry"), "Unknown Build Log slugs must not leak into public metadata.");
