...
const requiredRoutes = [
  ...
  "/", "/start-here", "/archive", "/marketplace", "/marketplace/browse", "/marketplace/addons/:id",
  ...
  "/legal/trademark-notice", "/legal/third-party-media-credits", "/legal/support-and-billing-terms", "/legal/refund-and-cancellation-policy", "/legal/sandbox-credit-terms", "/legal/job-post-fee-terms", "/legal/marketplace-commerce-terms", "/legal/organization-services-terms", "/legal/sponsorship-independence-policy", "/legal/account-closure-financial-retention", "/legal/living-library-third-party-resources", "/admin", "/admin/moderation", "/admin/reports", "/admin/economic-operations", "/admin/economic-operations/:section",
