...
export default {
  async fetch(request, env) {
    ...
    const methods = { '/inspect': 'inspect', '/record-catalog': 'recordCatalog', '/readiness': 'readiness', '/checkout': 'startGuestCheckout', '/job': 'accountFlow', '/recurring': 'accountFlow', '/portal': 'accountFlow', '/refund': 'accountFlow', '/reconcile': 'reconcile' };
